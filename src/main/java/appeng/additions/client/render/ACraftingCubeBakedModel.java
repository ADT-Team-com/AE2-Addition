...
public abstract class ACraftingCubeBakedModel implements IDynamicBakedModel {
    ...
    public ACraftingCubeBakedModel(TextureAtlasSprite ringCorner, TextureAtlasSprite ringHor, TextureAtlasSprite ringVer) {
