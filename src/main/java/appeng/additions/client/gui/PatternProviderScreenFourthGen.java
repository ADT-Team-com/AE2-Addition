...
public class PatternProviderScreenFourthGen extends AEBaseScreen<PatternProviderMenuFourthGen> {

    private final SettingToggleButton<YesNo> blockingModeButton;
    private final ToggleButton showInInterfaceTerminalButton;

    public PatternProviderScreenFourthGen(PatternProviderMenuFourthGen menu, Inventory playerInventory, Component title,
                                          ScreenStyle style) {
