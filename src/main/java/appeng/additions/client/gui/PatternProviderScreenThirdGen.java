...
public class PatternProviderScreenThirdGen extends AEBaseScreen<PatternProviderMenuThirdGen> {

    private final SettingToggleButton<YesNo> blockingModeButton;
    private final ToggleButton showInInterfaceTerminalButton;

    public PatternProviderScreenThirdGen(PatternProviderMenuThirdGen menu, Inventory playerInventory, Component title,
                                         ScreenStyle style) {
