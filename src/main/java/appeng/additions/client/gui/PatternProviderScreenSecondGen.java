...
public class PatternProviderScreenSecondGen extends AEBaseScreen<PatternProviderMenuSecondGen> {

    private final SettingToggleButton<YesNo> blockingModeButton;
    private final ToggleButton showInInterfaceTerminalButton;

    public PatternProviderScreenSecondGen(PatternProviderMenuSecondGen menu, Inventory playerInventory, Component title,
                                 ScreenStyle style) {
