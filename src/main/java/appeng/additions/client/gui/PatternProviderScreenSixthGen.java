...
import appeng.additions.menu.PatternProviderMenuSixthGen;
...
public class PatternProviderScreenSixthGen extends AEBaseScreen<PatternProviderMenuSixthGen> {

    private final SettingToggleButton<YesNo> blockingModeButton;
    private final ToggleButton showInInterfaceTerminalButton;

    public PatternProviderScreenSixthGen(PatternProviderMenuSixthGen menu, Inventory playerInventory, Component title,
                                         ScreenStyle style) {
