...
public class AdvancedInterfaceTerminalScreen<C extends AdvancedInterfaceTerminalMenu> extends AEBaseScreen<C> {
    ...
    public AdvancedInterfaceTerminalScreen(C menu, Inventory playerInventory,
    ...
    private void refreshList() {
        ...
        for (String n : this.names) {
            ...
            clientInventories.sort((a, b) -> {
                int l = a.compareTo(b);
                if (l == 0) return Long.compare(a.getServerId(), b.getServerId());
                return l;
            });
