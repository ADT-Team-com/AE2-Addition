...
public class PatternProviderMenuSixthGen extends AEBaseMenu {

    public static final MenuType<PatternProviderMenuSixthGen> TYPE = MenuTypeBuilder
            .create(PatternProviderMenuSixthGen::new, PatternProviderLogicHost.class)
            .requirePermission(SecurityPermissions.BUILD)
            .build("pattern_provider_6th");
    ...
    public PatternProviderMenuSixthGen(int id, Inventory playerInventory, PatternProviderLogicHost host) {
