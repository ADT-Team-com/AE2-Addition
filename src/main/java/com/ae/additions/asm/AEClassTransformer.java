...
public class AEClassTransformer implements IClassTransformer {
    ...
    private static byte[] transformGuiInterfaceTerminal(byte[] basicClass) {
        ...
        }
        {
            ...
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", IS_DEV ? "getBoolean" : "func_74767_n", "(Ljava/lang/String;)Z", false);
            ...
            methodVisitor.visitVarInsn(ALOAD, 1);
            methodVisitor.visitVarInsn(ALOAD, 4);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", IS_DEV ? "getCompoundTag" : "func_74775_l", "(Ljava/lang/String;)Lnet/minecraft/nbt/NBTTagCompound;", false);
            ...
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "appeng/tile/inventory/AppEngInternalInventory", IS_DEV ? "getSizeInventory" : "func_70302_i_", "()I", false);
            ...
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", IS_DEV ? "hasKey" : "func_74764_b", "(Ljava/lang/String;)Z", false);
            ...
            methodVisitor.visitVarInsn(ALOAD, 10);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", IS_DEV ? "getCompoundTag" : "func_74775_l", "(Ljava/lang/String;)Lnet/minecraft/nbt/NBTTagCompound;", false);
            methodVisitor.visitMethodInsn(INVOKESTATIC, "net/minecraft/item/ItemStack", IS_DEV ? "loadItemStackFromNBT" : "func_77949_a", "(Lnet/minecraft/nbt/NBTTagCompound;)Lnet/minecraft/item/ItemStack;", false);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "appeng/tile/inventory/AppEngInternalInventory", IS_DEV ? "setInventorySlotContents" : "func_70299_a", "(ILnet/minecraft/item/ItemStack;)V", false);
        ...
        }
        {
            ...
            methodVisitor.visitVarInsn(ALOAD, 3);
            methodVisitor.visitLdcInsn("invSize");
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", IS_DEV ? "getInteger" : "func_74762_e", "(Ljava/lang/String;)I", false);
            Label label5 = new Label();
            ...
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", IS_DEV ? "getLong" : "func_74763_f", "(Ljava/lang/String;)J", false);
            ...
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/nbt/NBTTagCompound", IS_DEV ? "getString" : "func_74779_i", "(Ljava/lang/String;)Ljava/lang/String;", false);
            methodVisitor.visitVarInsn(ASTORE, 8);
            Label label12 = new Label();
            methodVisitor.visitLabel(label12);
        ...
        }
        {
            ...
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/gui/GuiScreen", IS_DEV ? "fontRendererObj" : "field_146289_q", "Lnet/minecraft/client/gui/FontRenderer;");
            methodVisitor.visitVarInsn(ALOAD, 0);
            ...
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/gui/FontRenderer", IS_DEV ? "drawString" : "func_78276_b", "(Ljava/lang/String;III)I", false);
            methodVisitor.visitInsn(POP);
            Label label1 = new Label();
            methodVisitor.visitLabel(label1);
            ...
            methodVisitor.visitIntInsn(BIPUSH, 8);
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/gui/inventory/GuiContainer", IS_DEV ? "ySize" : "field_147000_g", "I");
            ...
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/gui/inventory/GuiContainer", IS_DEV ? "inventorySlots" : "field_147002_h", "Lnet/minecraft/inventory/Container;");
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/inventory/Container", IS_DEV ? "inventorySlots" : "field_75151_b", "Ljava/util/List;");
            ...
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/gui/GuiScreen", IS_DEV ? "fontRendererObj" : "field_146289_q", "Lnet/minecraft/client/gui/FontRenderer;");
            methodVisitor.visitVarInsn(ALOAD, 11);
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/gui/FontRenderer", IS_DEV ? "getStringWidth" : "func_78256_a", "(Ljava/lang/String;)I", false);
        ...
        }
        {
            ...
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "appeng/client/gui/AEBaseGui", "bindTexture", "(Ljava/lang/String;)V", false);
            Label label1 = new Label();
            methodVisitor.visitLabel(label1);
            ...
            methodVisitor.visitInsn(ICONST_0);
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/gui/inventory/GuiContainer", IS_DEV ? "xSize" : "field_146999_f", "I");
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitFieldInsn(GETFIELD, "net/minecraft/client/gui/inventory/GuiContainer", IS_DEV ? "ySize" : "field_147000_g", "I");
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/gui/Gui", IS_DEV ? "drawTexturedModalRect" : "func_73729_b", "(IIIIII)V", false);
            Label label2 = new Label();
            methodVisitor.visitLabel(label2);
            ...
            methodVisitor.visitVarInsn(ALOAD, 0);
            methodVisitor.visitFieldInsn(GETFIELD, "appeng/client/gui/implementations/GuiInterfaceTerminal", "searchField", "Lappeng/client/gui/widgets/MEGuiTextField;");
            methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/minecraft/client/gui/GuiTextField", IS_DEV ? "drawTextBox" : "func_146194_f", "()V", false);
            methodVisitor.visitLabel(label27);
