...
public class PartUltimateInterface extends PartBasicState implements IGridTickable, IStorageMonitorable, IInventoryDestination, IInterfaceHost, ISidedInventory, IAEAppEngInventory, ITileStorageMonitorable, IPriorityHost {
    ...
    private final TUltimateDualityInterface duality = new TUltimateDualityInterface(this.getProxy(), this);
    ...
    protected ItemStack getItemFromTile(Object obj) {
        return new ItemStack(AAModItems.ITEM_PARTS, 1, 2);
    }
    ...
    @Override
    public TUltimateDualityInterface getInterfaceDuality() {
        return this.duality;
    }
