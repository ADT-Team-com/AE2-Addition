...
public class PartAdvancedInterface extends PartBasicState implements IGridTickable, IStorageMonitorable, IInventoryDestination, IInterfaceHost, ISidedInventory, IAEAppEngInventory, ITileStorageMonitorable, IPriorityHost {
    ...
    private final TAdvancedDualityInterface duality = new TAdvancedDualityInterface(this.getProxy(), this);
    ...
    protected ItemStack getItemFromTile(Object obj) {
        return new ItemStack(AAModItems.ITEM_PARTS, 1, 0);
    }
    ...
    @Override
    public TAdvancedDualityInterface getInterfaceDuality() {
        return this.duality;
    }
