...
import com.ae.addition.common.utils.THybridDualityInterface;
...
public class TileHybridInterface extends TileInterface {
    ...
    private final THybridDualityInterface duality;
    private ForgeDirection pointAt;

    public TileHybridInterface() {
        this.pointAt = ForgeDirection.UNKNOWN;
        this.duality = new THybridDualityInterface(this.getProxy(), this);
    }
