...
public class GuiHybridInterface extends GuiUpgradeable {
    ...
    public void drawFG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
        if (this.BlockMode != null) {
            this.BlockMode.set(((ContainerHybridInterface) this.cvb).getBlockingMode());
        }

        if (this.interfaceMode != null) {
            this.interfaceMode.setState(((ContainerHybridInterface) this.cvb).getInterfaceTerminalMode() == YesNo.YES);
        }
