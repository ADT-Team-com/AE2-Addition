package com.ae.addition.client.gui;
...
public class GuiUltimateInterface extends GuiUpgradeable {
    ...
    public void drawFG(final int offsetX, final int offsetY, final int mouseX, final int mouseY) {
        if (this.BlockMode != null) {
            this.BlockMode.set(((ContainerUltimateInterface) this.cvb).getBlockingMode());
        }

        if (this.interfaceMode != null) {
            this.interfaceMode.setState(((ContainerUltimateInterface) this.cvb).getInterfaceTerminalMode() == YesNo.YES);
        }

        this.fontRendererObj.drawString(this.getGuiDisplayName(GuiText.Interface.getLocal()), 8 + 50, 3, 4210752);

        this.fontRendererObj.drawString(GuiText.Config.getLocal(), 8, 6, 4210752);
        this.fontRendererObj.drawString(GuiText.StoredItems.getLocal(), 8, 6 + 39 + 7, 4210752);
        this.fontRendererObj.drawString(GuiText.Patterns.getLocal(), 8, 6 + 55 + 7, 4210752);
